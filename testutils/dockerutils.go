...
const (
	...
	rabbitmq       = "https://github.com/PROPSProject/go-utils.git#feature/dockerfiles:dockerfiles/rabbitmq"
	host           = "127.0.0.1"
)
...
func StartRabbitmqContainerV1() *chan bool {
	...
	_, err = cli.ImageBuild(ctx, bytes.NewReader(make([]byte, 1000)), opts)
	if err != nil {
		panic(err)
	}
